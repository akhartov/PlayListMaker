...
import com.practicum.playlistmaker.playlist.ui.editor.PlaylistMakerViewModel
...
val playlistViewModelModule = module {
    ...
    single<CoverRepository> { CoverRepositoryImpl(get(), get()) }
    ...
    single { CoversInteractor(get(), get(), get()) }

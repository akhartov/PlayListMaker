...
class PlaylistViewHolder(
    ...
    private val clickListener: OnCoverClickListener?
) : RecyclerView.ViewHolder(binding.root) {

    fun bind(cover: PlaylistCover) {
        binding.playlistTitle.text = cover.title
        binding.playlistInfo.text = cover.tracksCountText
        ...
        itemView.setOnClickListener {
            clickListener?.onCoverClick(cover)
        }
    }

    fun interface OnCoverClickListener {
        fun onCoverClick(cover: PlaylistCover)
    }

    companion object {
        fun from(parent: ViewGroup, clickListener: OnCoverClickListener?): PlaylistViewHolder {
